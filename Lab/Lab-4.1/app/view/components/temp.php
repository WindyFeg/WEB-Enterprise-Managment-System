    ...
    <div class="container main">
        ...
        if ($sql->num_rows) {
            ...
            for ($i = 1; $i <= $numberOfPage; $i++) {
                ...
                if ($p == $i) {
                    echo '<li class="page-item"><a class="page-link active-pagination" href="http://localhost:8888/Lab/Lab-3.1/index.php?page=products&p=' . $i . '$itemPerPage=' . $numberOfItemPerPage . '">' . $i . '</a></li>';
                } else {
                    echo '<li class="page-item"><a class="page-link" href="http://localhost:8888/Lab/Lab-3.1/index.php?page=products&p=' . $i . '$itemPerPage=' . $numberOfItemPerPage . '">' . $i . '</a></li>';
                }
            }
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="http://localhost:8888/Lab/Lab-4.1/index.php?page=products&p=' . $p . '&itemPerPage=10">10</a>
                <a class="dropdown-item" href="http://localhost:8888/Lab/Lab-4.1/index.php?page=products&p=' . $p . '&itemPerPage=20">20</a>
                <a class="dropdown-item" href="http://localhost:8888/Lab/Lab-4.1/index.php?page=products&p=' . $p . '&itemPerPage=30">30</a>
            </div>
        </div>
            ';
        } else
